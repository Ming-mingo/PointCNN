...
CUDA_VISIBLE_DEVICES=$gpu python3 ../train_val_seg.py -t ../../data/S3DIS/out_part_rgb/train1.txt -v ../../data/S3DIS/out_part_rgb/val1.txt -s ../../models/seg/ -m pointcnn_seg -x $setting > ../../models/seg/pointcnn_seg_$setting.txt 2>&1 &
